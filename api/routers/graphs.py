...
def get_constellation_graph(
    ...
    LET members = (
        ...
        RETURN {{
            ...
            name: v.canonical.name || v.identifier || "Unknown",
            country: v.canonical.country_of_origin || v.canonical.country,
            orbital_band: v.canonical.orbital_band,
            status: v.canonical.status,
            launch_date: v.canonical.date_of_launch || v.canonical.launch_date,
            is_hub: false
        }}
    )
    ...
    LET hub_node = hub_doc ? {{
        ...
        name: hub_doc.canonical.name || hub_doc.identifier || "Unknown",
        country: hub_doc.canonical.country_of_origin || hub_doc.canonical.country,
        orbital_band: hub_doc.canonical.orbital_band,
        status: hub_doc.canonical.status,
        launch_date: hub_doc.canonical.date_of_launch || hub_doc.canonical.launch_date,
        is_hub: true
    }} : null
    ...
    try:
        ...
        LET nodes = APPEND(
            [{{
                ...
                name: source.canonical.name || source.identifier || "Unknown",
                country: source.canonical.country_of_origin || source.canonical.country,
                orbital_band: source.canonical.orbital_band,
                status: source.canonical.status,
                launch_date: source.canonical.date_of_launch || source.canonical.launch_date,
            ...
            (
                FOR n IN neighbors
                    ...
                    RETURN is_reg_doc ? {{
                        ...
                        name: n.vertex.canonical.name || n.vertex.identifier || "Unknown",
                        country: n.vertex.canonical.country_of_origin || n.vertex.canonical.country,
                        orbital_band: n.vertex.canonical.orbital_band,
                        status: n.vertex.canonical.status,
                        launch_date: n.vertex.canonical.date_of_launch || n.vertex.canonical.launch_date,
    ...
    LET satellites_in_period = (
        FOR doc IN {COLLECTION_NAME}
            ...
            RETURN {{
                ...
                name: doc.canonical.name || doc.identifier || "Unknown",
                launch_date: doc.canonical.date_of_launch || doc.canonical.launch_date,
                launch_year: year,
