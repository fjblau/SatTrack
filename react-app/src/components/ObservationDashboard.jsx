  ...
  const allChartData = useMemo(() => {
    return [...observations]
      ...
      .map(obs => ({
        ...
        materialConfidence: obs.material_confidence ?? obs.material_signature?.confidence,
        ...
        manConf: obs.maneuver_confidence ?? obs.maneuver_indicator?.confidence,
        manFlag: obs.maneuver_flag ?? obs.maneuver_indicator?.flag,
