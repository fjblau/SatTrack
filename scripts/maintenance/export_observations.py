...
timestamped JSONL backup files.
...
Usage:
    python scripts/maintenance/export_observations.py [--output-dir DIR]
"""
...
def run(output_dir: str | None):
    print("Export Observations", flush=True)
...
def main():
    parser = argparse.ArgumentParser(description="Export all observation data to JSONL backup files")
