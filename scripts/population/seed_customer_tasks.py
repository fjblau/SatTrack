...
CUSTOMER_TASKS = [
    # §6.1 canonical: TSK-2026-0001 — closed
    {
        ...
        "scope": {
            ...
            "maneuver_authorised": False,
            "min_independence_score": 0.75,
        },
        "commercial": {
            "fee_amount": 48000,
            "currency": "USD",
            "billing": "invoiced",
            "po_reference": "PO-2026-0001-A",
        },
        "sla": {
    ...
    # §6.2 canonical: TSK-2026-0028 — executing
    {
        ...
        "scope": {
            ...
            "min_independence_score": 0.6,
        },
        "commercial": {
            "fee_amount": 22500,
            "currency": "USD",
            "billing": "invoiced",
            "po_reference": "PO-2026-0028-B",
        },
        "sla": {
    ...
    },
    {
        ...
        "scope": {
            ...
            "required_sensor_types": ["optical"],
            "maneuver_authorised": True,
            "min_independence_score": 0.65,
        },
        "commercial": {
            "fee_amount": 25000,
            "currency": "USD",
            "billing": "prepaid",
            "po_reference": "PO-2026-0007-C",
        },
        "sla": {
...
def _deliverable_for(task: dict) -> dict | None:
    ...
    return {
        ...
        "released_to_customer": task["status"] in {"accepted_by_customer", "closed"},
        "_task_seed": True,
    }
